# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-01-11 12:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('citekey', publications.fields.NullCharField(blank=True, help_text='BibTex citation key. Leave blank if unsure.', max_length=512, null=True, unique=True)),
                ...
                ('series', models.CharField(blank=True, max_length=256, verbose_name='The name of a series or set of books. When citing an entire book, the <title> field gives its title and an optional <series> field gives the name of a series or multi-volume set in which the book is published.')),
                ...
                ('pdf', models.FileField(blank=True, null=True, upload_to='publications-bootstrap/', verbose_name='PDF')),
                ('image', models.ImageField(blank=True, null=True, upload_to='publications-bootstrap/images/')),
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to='publications-bootstrap/thumbnails/')),
                ('external', models.BooleanField(default=False, help_text='If publication was written in another lab, mark as external.')),
                ('abstract', models.TextField(blank=True)),
                ('doi', publications.fields.NullCharField(blank=True, max_length=128, null=True, unique=True, verbose_name='DOI')),
                ('isbn', publications.fields.NullCharField(blank=True, help_text='Only for a book.', max_length=32, null=True, unique=True, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hidden', models.BooleanField(default=False, help_text='Hide publications-bootstrap from main view.')),
            ],
            options={
                'ordering': ('order',),
            },
