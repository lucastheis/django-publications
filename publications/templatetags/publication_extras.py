...
def get_publication(context, id):
    ...
    return render_template('publications/components/publication.html', context['request'], {'publication': pbl[0]})
...
def get_publication_list(context, list, template='publications/pages/publications.html'):
    ...
    return render_template(template, context['request'], {'list': list, 'publications': publications})
